...
<div class="panel-group login-panel-container forgot-password" id="sreb">
    <div class="panel panel-default lfr-panel lfr-panel-extended" id="mfqc">
        <div class="panel-heading toggler-header toggler-header-expanded" data-persist-id="mfqc">
            <div class="panel-toggle"> <i class="icon-envelope"></i> <span class="title-text"> Forgot Password </span></div>
        </div>
